...
foreach ($arResult['QUESTIONS'] as &$question) {
    ...
    } elseif ($question['SID'] === 'VACANCY_NAME') {
        $question['EXTRA_ATTRS'] = 'data-modal-vacancy="position" readonly';
        $question['EXTRA_CLASS'] = '';
    } elseif ($question['SID'] === 'VACANCY_ID') {
        $question['EXTRA_ATTRS'] = 'data-modal-vacancy="id"';
        $question['EXTRA_CLASS'] = '';
        $question['INPUT_TYPE'] = 'hidden';
    } elseif ($question['SID'] === 'FILE') {
