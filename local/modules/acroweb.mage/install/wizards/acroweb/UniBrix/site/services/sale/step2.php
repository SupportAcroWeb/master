...
if(COption::GetOptionString("acroweb_unibrix", "wizard_installed", "N", WIZARD_SITE_ID) != "Y")
{
	$locationGroupID = 0;
	$arLocationArr = Array();
...
COption::SetOptionString("acroweb_unibrix", "wizard_installed", "Y", false, WIZARD_SITE_ID);
