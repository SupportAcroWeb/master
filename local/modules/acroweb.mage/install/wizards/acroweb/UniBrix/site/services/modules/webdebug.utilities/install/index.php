...
class webdebug_utilities extends CModule {
	...
	function DoInstall() {
		...
		$this->registerHandler('main', 'OnAfterUserAuthorize');
		#
		return true;
	}
	...
	function DoUninstall() {
		...
		#
		require_once(__DIR__.'/emails_uninstall.php');
		...
		$this->unregisterHandler('main', 'OnAfterUserAuthorize');
		$this->UnInstallFiles();
		$this->UnInstallDB();
		#
	...
	# Tmp: \Bitrix\Main\EventManager::getInstance()->registerEventHandler('main', 'OnAfterUserAuthorize', 'webdebug.utilities', '\WD\Utilities\EventHandler', 'OnAfterUserAuthorize');
	...
	# Tmp: \Bitrix\Main\EventManager::getInstance()->unregisterEventHandler('main', 'OnAfterUserAuthorize', 'webdebug.utilities', '\WD\Utilities\EventHandler', 'OnAfterUserAuthorize');
