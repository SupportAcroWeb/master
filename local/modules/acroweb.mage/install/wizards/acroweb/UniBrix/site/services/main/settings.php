...
// Получаем ID шаблона и сайта из объекта wizard
$templateID = $wizard->GetVar("templateID");
$siteID = $wizard->GetVar("siteID");

if (!empty($templateID) && !empty($siteID)) {
    // Удаляем все существующие записи для данного сайта
    $result = SiteTemplateTable::getList([
    ...
    // Добавляем новую запись с выбранным шаблоном
