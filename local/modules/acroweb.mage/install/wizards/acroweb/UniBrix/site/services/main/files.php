...
if (COption::GetOptionString("acroweb.mage", "wizard_installed", "N", WIZARD_SITE_ID) == "N"
...
)
{
	...
	COption::SetOptionString("acroweb.mage", "template_converted", "Y", "", WIZARD_SITE_ID);
}
elseif (COption::GetOptionString("acroweb.mage", "template_converted", "N", WIZARD_SITE_ID) == "N")
{
	CopyDirFiles(
...
if ($wizard->GetVar("templateID") != "acroweb.mage")
{
...
if(COption::GetOptionString("acroweb.mage", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA)
	return;
