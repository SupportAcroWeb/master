...
if ((string)$request->get('ORDER_ID') !== '') {
    ...
    <form action="<?= POST_FORM_ACTION_URI ?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form"
        ...
        <!--	AUTH BLOCK	-->
        <div id="bx-soa-auth" class="bx-soa-section bx-soa-auth"
             style="display:none">
        ...
        <div id="bx-soa-order" class="block-order__content form columns-grid2 block-order2">
            <!--	MAIN BLOCK	-->
            <div class="columns-grid2__content block-order__body block1 bx-soa">
                <!--	REGION BLOCK	-->
                <div id="bx-soa-region" data-visited="false"
                     class="block-order__column bx-soa-section bx-active">
                    <div class="bx-soa-section-content container-fluid"></div>
                </div>
                ...
                <div class="columns-grid2__content-inner">
                    <div class="container-grid1">
                        ...
                        <div class="block-order__column container-grid1__row border-container">
                            ...
                            <div class="addres-block-order courier-delivery _active"
                                 data-props-group="external_delivery"
                                 style="display:none">
                                <div class="form">
                                    <div class="form-grid1">
                                    </div>
                        ...
                        <div id="bx-soa-basket" data-visited="false"
                             class="container-grid1__row border-container order-products block-order__column bx-soa-section bx-active">
            ...
            <!--	SIDEBAR BLOCK	-->
            <div id="bx-soa-total" class="columns-grid2__aside details-block-cart bx-soa-sidebar"></div>
        </div>
    </form>
