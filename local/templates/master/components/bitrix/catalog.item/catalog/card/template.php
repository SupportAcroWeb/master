...
?>
    ...
    <div class="card-product3__col1" data-entity="price-block" <?= $isPriceZero ? 'style="display: none;"' : '' ?>>
        <div>
            ...
            <span class="card-product3__price1" id="<?= $itemIds['PRICE'] ?>">
			<?
            if (!empty($price)) {
            ...
            if ($arParams['SHOW_OLD_PRICE'] === 'Y' && !empty($price)) {
                ?>
                <span class="card-product3__price2" id="<?= $itemIds['PRICE_OLD'] ?>"
        ...
        <div class="card-product3__col2-inner">
            ...
            <div class="card-product3__sum">
                ...
                <span class="card-product3__price3"
                      id="<?= $itemIds['PRICE_TOTAL'] ?>"><?= $price['PRINT_RATIO_PRICE'] ?></span>
            </div>
        </div>
    </div>
    <? if ($isPriceZero): ?>
    ...
    <div class="card-product3__col4">
        ...
        <button class="card-product3__btn-favorite btn-favorites" type="button" data-id="<?= $item["ID"] ?>">
