            ...
            <div class="container">
                <div class="header__grid1">
                    ...
                    <div class="header__cell-callback">
                        <button data-hystmodal="#modalCallback" class="btn-text btn-text_primary btn-text_dotted" type="button">Заказать звонок</button>
                    </div>
                    ...
                    <div class="header__cell-toolbar">
                        ...
                        <?php if ($USER->IsAuthorized()): ?>
                            <div class="header__btn-user-wrap">
                                <button class="btn-circle header__btn-user active" type="button">
                                ...
                                <div class="menu-main__sub">
                                    <ul>
                                        ...
                                        <li><a href="<?= $APPLICATION->GetCurPageParam('logout=yes&' . bitrix_sessid_get(), ['logout']) ?>" class="exit">Выход</a></li>
                                    </ul>
                                </div>
                            </div>
                            <a href="/personal/favorites/" class="btn-circle">
                                <span class="v-h">Избранное</span>
                                <svg class="desk" width="25" height="23" aria-hidden="true">
                        ...
                        <?php else: ?>
                            ...
                            <a href="/favorites/" class="btn-circle">
                                <span class="v-h">Избранное</span>
                                <svg class="desk" width="25" height="23" aria-hidden="true">
                                    <use xlink:href="<?= SITE_TEMPLATE_PATH ?>/img/sprite.svg#heart1"></use>
                                </svg>
                            ...
                            <div class="menu-catalog__user">
                                <?php if ($USER->IsAuthorized()): ?>
                                    ...
                                    <div>
                                        ...
                                        <a class="menu-catalog__logout" href="<?= $APPLICATION->GetCurPageParam('logout=yes&' . bitrix_sessid_get(), ['logout']) ?>">
